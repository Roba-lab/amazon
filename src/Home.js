  ...
  return (
    <div className="home_container">
      ...
      <div className="home_row">
        ...
        <Product
          id="7"
          title="Citizen CZ Smart Hybrid smartwatch 44mm Stainless Steel, Continuous Heart Rate Tracking, Fitness Activity, Golf App, Displays Notifications and Messages, Bluetooth Connection, 15 Day Battery Life.
          Visit the Citizen Watches Store"
          price={350.0}
          rating={4}
          image="https://m.media-amazon.com/images/I/81N1Jg0Cv1L._AC_SL1500_.jpg"
        />
      </div>
